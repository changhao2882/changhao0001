...
public class MyBatisTest {
	...
	public void test01(){
		...
		//创建第二个查询条件
		Criteria criteria4 = example2.createCriteria();
		criteria4.andAddressLike("%%");
		criteria4.andBirthDateBetween(new Date(), new Date());
		
		//or
		example2.or(criteria3);
		example2.or(criteria4);
		System.out.println("=======-=-=-=-=-=-=-");
		List<Teacher> selectByExample = mapper.selectByExample(example2);
		for (Teacher teacher : selectByExample) {
			System.out.println(teacher);
		}
